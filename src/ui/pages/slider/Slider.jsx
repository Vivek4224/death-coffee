        ...
        <div>
            <Fade>
                <div className="each-slide">
                    <div>
                        <img src={image1} style={{ width: "100%", filter: "brightness(0.5)" }} />
                    </div>
                    <div className="details1" style={{ position: "absolute", top: "8rem", left: "5rem", marginBottom: "1.5rem" }}>
                        ...
                        <button className="slider_btn" style={{ padding: "0.8rem 1rem", backgroundColor: "#63181A", border: "none", color: "white", fontWeight: "900", fontFamily: "fenomen", letterSpacing: ".1rem", cursor: "pointer", marginRight: "1rem" }}>SHOP NOW</button>
                ...
                <div className="each-slide">
                    <div>
                        <img src={image2} style={{ width: "100%", filter: "brightness(0.5)" }} />
                    </div>
                    <div className="details2" style={{ position: "absolute", top: "8rem", left: "5rem", marginBottom: "1.5rem" }}>
                        ...
                        <button style={{ padding: "0.8rem 1rem", backgroundColor: "#63181A", border: "none", color: "white", fontWeight: "900", fontFamily: "fenomen", letterSpacing: ".1rem", cursor: "pointer", marginRight: "1rem" }}>SHOP MUGS</button>
